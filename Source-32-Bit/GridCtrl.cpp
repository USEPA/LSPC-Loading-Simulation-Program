...
BOOL CGridCtrl::PasteTextToGrid(CCellID cell, COleDataObject* pDataObject)
{
	...
	if (szBuffer != NULL)     delete szBuffer;          
...
BOOL CGridCtrl::SetItemText(int nRow, int nCol, CString str)
{
	return SetItemText(nRow,nCol,LPCSTR(str));
}

BOOL CGridCtrl::SetItemInt(int nRow, int nCol, int nNum)
{
	CString str;
	str.Format("%d",nNum);
	return SetItemText(nRow,nCol,LPCSTR(str));
...
BOOL CGridCtrl::SetItemFloat(int nRow, int nCol, double fNum)
{
	CString str;
...
int CGridCtrl::GetItemInt(int nRow, int nCol)
{
	CString str = GetItemText(nRow, nCol);
	int nNum;
	sscanf(LPCSTR(str),"%d",&nNum);
	return nNum;
}

double CGridCtrl::GetItemFloat(int nRow, int nCol)
{
	CString str = GetItemText(nRow, nCol);
	double fNum;
	sscanf(LPCSTR(str),"%lf",&fNum);
	return fNum;
}
