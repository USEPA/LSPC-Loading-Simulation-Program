...
public:
	...
	BOOL   SetItemText(int nRow, int nCol, CString str);
	BOOL   SetItemInt(int nRow, int nCol, int nNum);
	BOOL   SetItemFloat(int nRow, int nCol, double fNum);
    virtual CString GetItemText(int nRow, int nCol);
	int GetItemInt(int nRow, int nCol);
	double GetItemFloat(int nRow, int nCol);
